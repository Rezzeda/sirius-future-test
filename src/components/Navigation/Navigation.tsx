    ...
    return (
        <div className={styles.menu}>
            <div className={styles.title}>
                ...
                <h1 className={styles.title__text}>Sirius Future</h1>
            </div>
            <nav className={styles.menu__nav}>
                <ul className={styles.menu__list}>
                    ...
                    <li className={styles.menu__list_item}>
                        ...
                        >
                            <svg className={styles.menu__icon_filled} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path fillRule="evenodd" clipRule="evenodd" d="M19 4H5C3.895 4 3 4.895 3 6V19C3 20.105 3.895 21 5 21H19C20.105 21 21 20.105 21 19V6C21 4.895 20.105 4 19 4Z" stroke='currentColor' strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                    <path d="M7.01316 12.7285C6.87516 12.7285 6.76316 12.8405 6.76416 12.9785C6.76416 13.1165 6.87616 13.2285 7.01416 13.2285C7.15216 13.2285 7.26416 13.1165 7.26416 12.9785C7.26416 12.8405 7.15216 12.7285 7.01316 12.7285" stroke='currentColor' strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                    <path d="M12.0132 12.7285C11.8752 12.7285 11.7632 12.8405 11.7642 12.9785C11.7642 13.1165 11.8762 13.2285 12.0142 13.2285C12.1522 13.2285 12.2642 13.1165 12.2642 12.9785C12.2642 12.8405 12.1522 12.7285 12.0132 12.7285" stroke='currentColor' strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                    <path d="M17.0132 12.7285C16.8752 12.7285 16.7632 12.8405 16.7642 12.9785C16.7642 13.1165 16.8762 13.2285 17.0142 13.2285C17.1522 13.2285 17.2642 13.1165 17.2642 12.9785C17.2642 12.8405 17.1522 12.7285 17.0132 12.7285" stroke='currentColor' strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                    <path d="M7.01316 16.7285C6.87516 16.7285 6.76316 16.8405 6.76416 16.9785C6.76416 17.1165 6.87616 17.2285 7.01416 17.2285C7.15216 17.2285 7.26416 17.1165 7.26416 16.9785C7.26416 16.8405 7.15216 16.7285 7.01316 16.7285" stroke='currentColor' strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                    <path d="M12.0132 16.7285C11.8752 16.7285 11.7632 16.8405 11.7642 16.9785C11.7642 17.1165 11.8762 17.2285 12.0142 17.2285C12.1522 17.2285 12.2642 17.1165 12.2642 16.9785C12.2642 16.8405 12.1522 16.7285 12.0132 16.7285" stroke='currentColor' strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                            Расписание
                        </NavLink>
                    </li>
                    <li className={styles.menu__list_item}>
                        ...
                        >
                            <svg className={styles.menu__icon_filled} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.039 7.91473H19C20.105 7.91473 21 8.80973 21 9.91473V18.9997C21 20.0997 20.1 20.9997 19 20.9997H5C3.895 20.9997 3 20.1047 3 18.9997V8.29074C3 7.45874 3.515 6.71373 4.294 6.41973L14.647 2.51074C15.301 2.26374 16 2.74673 16 3.44573V7.91373" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M15.999 14.125C15.792 14.126 15.625 14.294 15.625 14.501C15.625 14.708 15.793 14.876 16 14.875C16.207 14.875 16.375 14.707 16.375 14.5C16.375 14.293 16.207 14.125 15.999 14.125" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                            Оплата
                        </NavLink>
                    </li>
                    ...
                    <li className={styles.menu__list_item}>
                        ...
                        >
                            <svg className={styles.menu__icon_filled} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M21.0037 15.6705V18.8919" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M21.0027 7.275V10.4963H21.0037C20.537 10.4022 20.0537 10.4336 19.6031 10.5874C18.7658 10.8737 18.1305 11.5647 17.9154 12.4231C17.7132 13.2142 17.8877 14.0544 18.3881 14.6996C18.8886 15.3447 19.659 15.7227 20.4755 15.7235C20.6529 15.7232 20.8298 15.7055 21.0037 15.6705V18.8918C21.0037 19.452 20.7813 19.9891 20.3852 20.3852C19.9891 20.7813 19.452 21.0038 18.8918 21.0037H15.6705V21.0047C15.7647 20.538 15.7333 20.0547 15.5795 19.6041C15.2932 18.7668 14.6021 18.1315 13.7437 17.9164C12.9526 17.7142 12.1125 17.8887 11.4673 18.3891C10.8221 18.8896 10.4442 19.66 10.4433 20.4765C10.4436 20.6539 10.4614 20.8308 10.4963 21.0047L7.276 21.0037C6.10994 21.0039 5.16446 20.0589 5.16412 18.8928V15.6715C4.99021 15.7065 4.81329 15.7242 4.6359 15.7245C3.81937 15.7237 3.049 15.3458 2.54854 14.7006C2.04808 14.0554 1.87362 13.2152 2.07583 12.4241C2.29086 11.5657 2.92617 10.8747 3.76354 10.5884C4.2141 10.4346 4.69743 10.4032 5.16412 10.4973H5.16312V7.276C5.16308 6.71588 5.38556 6.17869 5.78163 5.78263C6.17769 5.38657 6.71488 5.16408 7.275 5.16412H10.4963C10.4614 4.99021 10.4436 4.81329 10.4433 4.6359C10.4442 3.81937 10.8221 3.049 11.4673 2.54854C12.1125 2.04808 12.9526 1.87362 13.7437 2.07583C14.6018 2.29148 15.2926 2.92655 15.5795 3.76354C15.7333 4.2141 15.7647 4.69743 15.6705 5.16412H18.8918C19.452 5.16408 19.9891 5.38657 20.3852 5.78263C20.7813 6.17869 21.0037 6.71588 21.0037 7.276" stroke='currentColor' strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                            Тренажеры
                        </NavLink>
                    </li>
                    ...
                    <li className={styles.menu__list_item}>
                        ...
                        >
                            <svg className={styles.menu__icon_filled} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M18 17H19C20.105 17 21 16.105 21 15V12C21 10.895 20.105 10 19 10H18C17.448 10 17 10.448 17 11V16C17 16.552 17.448 17 18 17ZM18 17V18C18 19.105 17.105 20 16 20H13.875M18.5 10V9.5C18.5 5.91 15.59 3 12 3C8.41 3 5.5 5.91 5.5 9.5V10M13.875 20C13.875 19.31 13.315 18.75 12.625 18.75H11.375C10.685 18.75 10.125 19.31 10.125 20C10.125 20.69 10.685 21.25 11.375 21.25H12.625C13.315 21.25 13.875 20.69 13.875 20ZM6 17H5C3.895 17 3 16.105 3 15V12C3 10.895 3.895 10 5 10H6C6.552 10 7 10.448 7 11V16C7 16.552 6.552 17 6 17Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                            Проверка связи
                        </NavLink>
                    </li>
                    <li className={styles.menu__list_item}>
                        ...
                        >
                            <svg className={styles.menu__icon_filled} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.1213 9.87868C15.2929 11.0502 15.2929 12.9497 14.1213 14.1213C12.9497 15.2929 11.0502 15.2929 9.87868 14.1213C8.70711 12.9497 8.70711 11.0502 9.87868 9.87868C11.0502 8.70711 12.9497 8.70711 14.1213 9.87868" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    ...
                    <li className={styles.menu__list_item}>
                        ...
                        >
                            <svg className={styles.menu__icon_filled} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="12.0002" cy="11.9997" r="9.00375" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M12 12.7114L13.3276 11.9738C13.9901 11.6058 14.401 10.9075 14.401 10.1496C14.3225 8.88929 13.2417 7.92852 11.9808 7.99833C10.8543 7.95156 9.85385 8.71311 9.599 9.81149" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M12.1001 15.9018C12.1001 15.957 12.0553 16.0017 12 16.0017C11.9448 16.0017 11.9001 15.9569 11.9 15.9017C11.9 15.8465 11.9447 15.8017 12 15.8016C12.0265 15.8016 12.052 15.8121 12.0708 15.8309C12.0896 15.8497 12.1002 15.8752 12.1001 15.9018" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                            Вопросы
                        </NavLink>
                    </li>
